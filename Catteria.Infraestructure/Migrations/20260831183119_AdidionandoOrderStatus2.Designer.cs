...
namespace Catteria.Infraestructure.Migrations
{
    ...
    [Migration("20260831183119_AdidionandoOrderStatus2")]
    partial class AdidionandoOrderStatus2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Catteria.Domain.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Catteria.Domain.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Catteria.Domain.Entities.Favorite", b =>
                {
                    ...
                    b.HasOne("Catteria.Domain.Entities.ApplicationUser", "User")
                        .WithMany("Favorites")
            ...
            modelBuilder.Entity("Catteria.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasOne("Catteria.Domain.Entities.OrderStatus", "Status")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Catteria.Domain.Entities.OrderItem", b =>
                {
                    b.HasOne("Catteria.Domain.Entities.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("Catteria.Domain.Entities.Product", b =>
                {
                    b.HasOne("Catteria.Domain.Entities.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Catteria.Domain.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
