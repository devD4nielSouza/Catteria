...
namespace Catteria.Application.DTOs
{
    public class OrderItemDto
    {
        ...
        public decimal SubTotal { get; set; } // Subtotal do item do pedido (preço do produto multiplicado pela quantidade)
        public string ProductName { get; set; } = string.Empty; // Nome do produto associado ao item do pedido
